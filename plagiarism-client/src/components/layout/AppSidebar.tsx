...
import {
  Home, UserPlus, Users, Network, Settings, User, LogOut, ChevronLeft,
  FileSearch, FileText, GraduationCap, List,
} from "lucide-react";
...
export function AppSidebar() {
  ...
  return (
    ...
    >
      ...
      <nav className="mt-2 space-y-0.5 overflow-y-auto px-3" style={{ height: "calc(100vh - 4rem)" }}>
        {navItems.map((item, i) => {
